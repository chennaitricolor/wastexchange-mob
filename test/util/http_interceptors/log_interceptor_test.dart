...
void main() {
  ...
  test('check interceptRequest does not modify original data', () async {
    ...
    RequestData interceptedData = await logInterceptor.interceptRequest(data: requestData);
  ...
  test('check interceptResponse does not modify original data', () async {
    ...
    ResponseData interceptedResponse = await logInterceptor.interceptResponse(data: responseData);
