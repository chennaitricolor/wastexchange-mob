...
import 'package:wastexchange_mobile/core/widgets/thought_works_logo_powered.dart';
import 'package:wastexchange_mobile/features/home/presentation/widgets/drawer_item_view.dart';
            ...
            child: Column(
              children: <Widget>[
                ...
                DrawerItemView(
                  ...
                  text: 'Current Orders',
                  onItemPressed: () {
                    Router.popAndPushNamed(context, ViewBidsScreen.routeName);
                  },
                ),
                const Divider(),
                DrawerItemView(
